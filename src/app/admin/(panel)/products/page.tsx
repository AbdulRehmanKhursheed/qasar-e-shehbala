...
const COLUMNS: Column<AdminProductRow>[] = [
  {
    ...
    cell: (row) => (
      <div className="flex items-center gap-3">
        ...
        <div>
          <Link href={`/admin/products/${row.id}/edit`} className="text-xs font-medium text-gray-900 hover:text-jewel hover:underline">
            {row.name}
          </Link>
  ...
  },
  {
    ...
    cell: (row) => (
      <div className="flex items-center gap-2">
        <Link href={`/admin/products/${row.id}/edit`} className="text-xs text-royal hover:underline">
          Edit
        </Link>
